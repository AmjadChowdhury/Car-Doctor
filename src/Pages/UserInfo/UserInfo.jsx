    ...
    <div className="flex flex-col lg:flex-row justify-between items-center gap-4 px-2 mb-2">
      <div className="space-y-2 w-full">
        <h1 className="text-xl lg:text-3xl font-extrabold">Hey, 
          <span className="text-orange-500 font-extrabold">{displayName} </span><br />welcome to carDoctor
        </h1>
      ...
      <div className="w-full">
        <div className="flex gap-2">
          ...
          <GiClick className="text-4xl text-orange-500" onClick={()=>setClick(!click)}></GiClick>
        </div>
        <div className={`${click? '': 'hidden'}`}>
          <div className="card bg-base-100 w-full shrink-0 border-2 border-orange-200">
            <form className="card-body" onSubmit={handleUpdate}>
              ...
              <input type="submit" value="Update" className="btn bg-orange-500 text-white text-lg font-extrabold" />
            </div>
            </form>
          </div>
        </div>
